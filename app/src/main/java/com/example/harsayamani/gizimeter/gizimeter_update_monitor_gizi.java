...
public class gizimeter_update_monitor_gizi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_monitor_gizi);
    ...
    private void dataUpdate() {
        ...
        String getNama = identifikasi.getStringExtra("nama");
        namaLengkap.setText(getNama);
    }
    ...
    public void hitungGizi(){
        ...
        final Intent iIdentifikasi = getIntent();

        String getID = iIdentifikasi.getStringExtra("id");


        boolean isUpdate = mydb.updateData(getID, namaLengkap.getText().toString(), tanggalCek.getText().toString(), jenis_kelamin, umurTahun.getText().toString(), umurBulan.getText().toString(), beratBadan.getText().toString(), tinggiBadan.getText().toString(), imt, hasil, saran_gizi);

        if(isUpdate)
            Toast.makeText(getApplicationContext(),"Data telah diperbaharui",Toast.LENGTH_LONG).show();
        else
            Toast.makeText(getApplicationContext(),"Data tidak diperbaharui",Toast.LENGTH_LONG).show();

        Intent intent = new Intent(this, gizimeter_list_data.class);
